...
if(isset($_POST['submit'])){
	...
	$sql ="update  task1 set id=$id, name='$name', email='$email', number=$number,size=$size, address='$address'
	where id=$id";
...
<div class="container mt-3">
	...
	<div class="mb-3">
		...
		<div class="mb-3">
         <textarea class="form-control" id="address" placeholder="Enter The Address" name="address" style="height:20vh;"></textarea><br>
          </div>
		<button class="btn btn-primary" name="editbtn" >Edit</a></button>
